    ...
    <table>
        ...
        <tr>
            <td><input type="text" name="patronymic" size="20"
                       placeholder="Patronymic" value="${sessionScope.contact.patronymic}"></td>
        ...
        <tr>
            <td><input type="text" name="mobileNumber" size="20"
                       placeholder="+380XXXXXXXXX" value="${sessionScope.contact.mobileNumber}"></td>
        ...
        <tr>
            <td><input type="text" name="homePhone" size="20"
                       placeholder="+380XXXXXXXXX" value="${sessionScope.contact.homePhone}"></td>
        ...
        <tr>
            <td><input type="text" name="address" size="20"
                       placeholder="address" value="${sessionScope.contact.address}"></td>
            <td style="color: black">
                Address
            </td>
        </tr>
        ...
        <tr>
            <td><input type="text" name="email" size="20"
                       placeholder="name@gmail.com" value="${sessionScope.contact.email}"></td>
